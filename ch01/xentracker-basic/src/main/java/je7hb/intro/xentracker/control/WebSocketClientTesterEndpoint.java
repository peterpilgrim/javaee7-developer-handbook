...
/**
 * The type WebSocketClientTesterEndpoint
 *
 * @author Peter Pilgrim (peter)
 */
public class WebSocketClientTesterEndpoint extends Endpoint {
    ...
    public WebSocketClientTesterEndpoint(String urlTemplateLink, String message) {
    ...
    public void onOpen(Session session, EndpointConfig config) {
        ...
        try {
            System.out.printf("%s.onOpen() ==>> sending message=[%s]\n",
