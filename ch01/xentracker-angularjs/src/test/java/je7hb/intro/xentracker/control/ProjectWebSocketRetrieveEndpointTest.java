...
public class ProjectWebSocketRetrieveEndpointTest {
    ...
    public void shouldInvokeServerEndpoint() throws Exception {
        ...
        URI uri = URI.create("ws://localhost:8181/xentracker/retrieve-all-projects");
