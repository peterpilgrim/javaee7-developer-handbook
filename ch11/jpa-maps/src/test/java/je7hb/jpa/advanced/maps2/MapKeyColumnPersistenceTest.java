...
public class MapKeyColumnPersistenceTest {

    @Deployment
    public static JavaArchive createDeployment() {
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class)
            .addClasses(Artist.class, LiveEvent.class, Utils.class)
                .addAsResource(
    ...
    public void shouldSaveArtistWithAlbum() throws Exception{
        ...
        LiveEvent event1 = new LiveEvent(97502, "Monster Tour", "WORLD", artist1 );
        artist1.getEvents().put( event1.getLiveType(), event1 );
